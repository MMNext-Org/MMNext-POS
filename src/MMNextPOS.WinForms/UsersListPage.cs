    ...
    public partial class UsersListPage : ListPage<User, IUserService>
    {
        ...
        protected override void ConfigureColumns(GridView view)
        {
            ...
            view.Columns.AddRange(new[]
            {
                ...
                new GridColumn { FieldName = "Username", Caption = "Username", Width = 120, Visible = true },
                ...
                new GridColumn { FieldName = "LastLoginAt", Caption = "Last Login", Width = 150, Visible = true },
        ...
        {
            // TODO: Wire UserEditForm with persistence (needs password hashing service)
