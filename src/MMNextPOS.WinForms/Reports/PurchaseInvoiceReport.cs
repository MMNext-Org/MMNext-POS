...
namespace MMNextPOS.WinForms.Reports
{
    ...
    public class PurchaseInvoiceReport : BaseReport
    {
        ...
        private new readonly IPurchaseService _purchaseService;
        private new readonly IProductService _productService;
        private new readonly ISupplierService _supplierService;
        ...
        private void BuildDetail(DetailBand band)
        {
            ...
            detailTable.Rows.Add(CreateHeaderRow(new[] { "#", "Product", "Qty", "Unit Cost", "Disc.", "Tax", "Total" }));
            band.Controls.Add(_detailTable);
        }
        ...
        private new XRTableRow CreateTotalRow(string label, XRLabel valueLabel)
        {
