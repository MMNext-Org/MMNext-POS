...
{
    /// <summary>
    /// List page for Units entity using the generic ListPage base class.
    /// </summary>
    public partial class UnitsListPage : ListPage<Unit, IUnitService>
    {
        public UnitsListPage(IUnitService service, IServiceProvider serviceProvider)
            : base(service, serviceProvider)
        {
        }

        protected override string GetPageTitle() => "Units";
        ...
        protected override void ConfigureColumns(GridView view)
        {
            ...
            view.Columns.AddRange(new[]
            {
                ...
                new GridColumn { FieldName = "Symbol", Caption = "Symbol", Width = 100, Visible = true },
        ...
        protected override async Task<IEnumerable<Unit>> GetItemsAsync(CancellationToken cancellationToken)
        {
        ...
        {
            using var dialog = _serviceProvider.GetRequiredService<UnitEditForm>();
        ...
        protected override async Task OnEditAsync(Unit entity)
        {
            using var dialog = _serviceProvider.GetRequiredService<UnitEditForm>();
