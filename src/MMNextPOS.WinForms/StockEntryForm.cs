...
{
    public partial class StockEntryForm : EditFormBase
    {
        ...
        private DateEdit _entryDateEdit = null!;
        ...
        {
            this.Text = _isNew ? "Stock Entry (Receive)" : "Stock Entry Adjustment";
            ...
            // Entry Date
            mainLayout.Controls.Add(CreateLabel("Entry Date *:"), 0, 6);
            _entryDateEdit = new DateEdit
            {
                Dock = DockStyle.Fill,
            ...
            mainLayout.Controls.Add(_entryDateEdit, 1, 6);

            // Status
            mainLayout.Controls.Add(CreateLabel("Status *:"), 0, 7);
            ...
            // Detail lines grid - product lines for this entry
            ...
            _okButton.Click += async (s, e) => { if (ValidateForm()) await SaveEntryAsync(); };
        ...
        private async Task SaveEntryAsync()
        {
            try
            {
                ...
                {
                    MovementNo = $"ENT-{DateTime.UtcNow:yyyyMMdd-HHmmss}",
                ...
                ShowInfo($"Stock entry {movement.MovementNo} saved successfully!");
                DialogResult = DialogResult.OK;
            }
            catch (Exception ex)
            {
                ShowError($"Failed to save stock entry: {ex.Message}");
            }
            finally
            {
                SetWaitCursor(false);
        ...
        public override void LoadEntityData(object entity)
        {
            ...
            _reasonEdit.Text = "Stock receive";
            _entryDateEdit.EditValue = DateTime.Today;
