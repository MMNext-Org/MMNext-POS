...
{
    /// <summary>
    /// List page for Categories entity using the generic ListPage base class.
    /// </summary>
    public partial class CategoriesListPage : ListPage<Category, ICategoryService>
    {
        public CategoriesListPage(ICategoryService service, IServiceProvider serviceProvider)
            : base(service, serviceProvider)
        {
        }

        protected override string GetPageTitle() => "Categories";
        ...
        protected override async Task<IEnumerable<Category>> GetItemsAsync(CancellationToken cancellationToken)
        {
